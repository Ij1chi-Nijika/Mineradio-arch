...
const APP_ICON = process.platform === 'linux'
...
async function createWindow() {
  ...
  process.env.MINERADIO_BEAT_CACHE_DIR = process.env.MINERADIO_BEAT_CACHE_DIR || path.join(app.getPath('userData'), 'beatmaps');
